...
import 'reservatons_page_copy_model.dart';
export 'reservatons_page_copy_model.dart';

class ReservatonsPageCopyWidget extends StatefulWidget {
  const ReservatonsPageCopyWidget({super.key});

  @override
  State<ReservatonsPageCopyWidget> createState() =>
      _ReservatonsPageCopyWidgetState();
}

class _ReservatonsPageCopyWidgetState extends State<ReservatonsPageCopyWidget> {
  late ReservatonsPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReservatonsPageCopyModel());
