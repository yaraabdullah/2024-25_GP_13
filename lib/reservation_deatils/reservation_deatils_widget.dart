...
import 'reservation_deatils_model.dart';
export 'reservation_deatils_model.dart';

class ReservationDeatilsWidget extends StatefulWidget {
  const ReservationDeatilsWidget({
    super.key,
    required this.docID,
  });
  ...
  @override
  State<ReservationDeatilsWidget> createState() =>
      _ReservationDeatilsWidgetState();
}

class _ReservationDeatilsWidgetState extends State<ReservationDeatilsWidget> {
  late ReservationDeatilsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReservationDeatilsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DoctorsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final reservationDeatilsDoctorsRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    reservationDeatilsDoctorsRecord.photo,
                                    width: 100.0,
                                    height: 100.0,
                                    fit: BoxFit.cover,
                                  ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      valueOrDefault<String>(
                                        reservationDeatilsDoctorsRecord.name,
                                        'Doctor-Name',
                                      ),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      valueOrDefault<String>(
                                        reservationDeatilsDoctorsRecord
                                            .speciality,
                                        'doctor',
                                      ),
                                      style: FlutterFlowTheme.of(context)
