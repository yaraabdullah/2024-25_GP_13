...
DocumentReference? get currentUserReference =>
    loggedIn ? StudentsRecord.collection.doc(currentUser!.uid) : null;

StudentsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : StudentsRecord.getDocument(StudentsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
